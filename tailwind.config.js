  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        "heading-3": ["18px", { lineHeight: "27px", letterSpacing: "-0.01rem", fontWeight: "700" }],
        eyebrow: [
          "12px",
        ...
        "logo-wordmark": ["22.921px", { lineHeight: "normal", fontWeight: "500" }],
        "footer-wordmark": ["19.8px", { lineHeight: "19.84px", letterSpacing: "-0.397px", fontWeight: "900" }],
        "footer-link": ["14px", { lineHeight: "21px", fontWeight: "400" }],
        "footer-legal": ["12px", { lineHeight: "18px", letterSpacing: "0.055em", fontWeight: "400" }],
      },
      letterSpacing: {
        "eyebrow-wide": "1.32px",
      },
